...
DEFAULT_REGISTRY = Registry(
    [
        RegistryEntry(
            ...
            supported_challenge_families=["slider", "rotate", "click", "text", "tiles", "press"],
        ...
        *[
            RegistryEntry(
                ...
                version="1.0.0",
                lifecycle_state="active" if family in {"slider", "rotate", "click"} else "candidate",
        ...
        RegistryEntry(
            ...
            output_schema="captcha-prediction/v1",
            sha256=artifact_hash({"id": "reference-raster-algorithms", "weights": False, "families": ["slider", "rotate", "click", "text", "tiles", "press"]}),
            authorization_scopes=["self_owned_local_reference"],
            health_status="ready",
            runtime_eligibility="positive_local_reference",
        ),
        RegistryEntry(
            ...
            sha256=artifact_hash({"generator": "reference-fixtures-v1", "families": ["slider", "rotate", "click", "text", "tiles", "press"]}),
            authorization_scopes=["self_owned_local_reference"],
            health_status="ready",
            runtime_eligibility="positive_local_reference",
        ),
